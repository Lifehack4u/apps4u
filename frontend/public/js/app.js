...
console.log('olga');
document.getElementById("logging").style.cursor = "pointer";
var MODAL_ACTIVE_CLASS_NAME = 'modal-active';
var formModal = document.querySelector('#form-modal');
var successModal = document.querySelector('#success-modal');
var form = document.querySelector('#form');
var openFormModalBtn = document.querySelector('#logging');
...
var closeFormModal = function closeFormModal() {
...
var openSuccessModal = function openSuccessModal() {
...
form.addEventListener('submit', function (e) {
  ...
  fetch("/", {
    ...
    return console.log('User was not registered');
  });
});
